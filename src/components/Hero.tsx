    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        <div className="mb-8 animate-fade-in">
          <span className="inline-block px-6 py-2 bg-amber-600/90 text-white text-sm font-semibold tracking-widest rounded-full mb-6 backdrop-blur-sm">
            DAL 1952
          </span>
          ...
          <p className="text-xl md:text-2xl text-stone-100 mb-12 max-w-3xl mx-auto leading-relaxed drop-shadow-lg">
            Porchetta artigianale di altissima qualità, seguendo una ricetta tradizionale
            italiana tramandata da generazioni
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <Button size="lg" variant="secondary" onClick={() => document.getElementById('storia')?.scrollIntoView({ behavior: 'smooth' })}>
            La Nostra Storia
          </Button>
        </div>
      </div>
