...
sono statici
poco curati lato UX
non valorizzano i prodotti
non accompagnano l’utente

Il cliente aveva bisogno di:

raccontare il brand
mostrare i prodotti in modo efficace
migliorare la percezione qualitativa
...
Nessun backend
Nessuna gestione ordini
Nessun pagamento online

👉 Perché?
Perché il cliente aveva bisogno di posizionamento e immagine, non di complessità tecnica inutile.

🔧 Possibili evoluzioni

Se il progetto dovesse evolvere:

Integrazione backend (CMS o API)
Sistema di ordini / prenotazioni
SEO avanzato
...
Capacità di lavorare su progetti reali
Attenzione a UX e obiettivi di business
